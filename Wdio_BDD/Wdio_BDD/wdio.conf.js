...
global.downloadDir = settings.downloadPath;

const drivers = {
    chrome: { version: settings.chromeVersion } // https://chromedriver.chromium.org/
...
exports.config = {
    ...
    // services: ['C:/TestAutoMathon/Drivers/chromedriver.exe'],
    ...
    // },
    onPrepare: () => {
        // Remove the `.test-run/cucumber/` folder that holds the json and report files
        removeSync('.test-reports/cucumber/json');
        removeSync('.test-reports/cucumber/report')
    ...
    onComplete:  () => {
       ...
       commonpage.rmdir(downloadDir);
        generate({
          // Required
          // This part needs to be the same path where you store the JSON files
          // default = '.test-run/cucumber/json/'
